...
private fun Any.observeAsState(listOf: Any): ReadOnlyProperty<Nothing?, List<NoteModel>> {

}

@Composable
fun AppDrawer(currentScreen: Screen.Trash, closeDrawerAction: () -> Job) {
...
@Composable
fun Note(note: NoteModel, onNoteClick: (NoteModel) -> Unit) {
